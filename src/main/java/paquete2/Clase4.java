...
/*                  Probando llamada a Atributos de la Clase1 del mismo paquete                             */
    ...
    System.out.println("Accediendo al atributoPublico de Clase1: "+ob3.atributoPublico); //--Puedo acceder a el por que es Publico   
...
/*  Probando llamada a Metodos de Clase 1 del mismo paquete                    */
    ...
    System.out.println("Accediendo a metodoPublico de Clase1: "+ob3.metodoPublico()); //--Puedo acceder a el por que es un metodo publico
  //  System.out.println("Accediendo a metodoProtegido de Clase1: "+ob3.metodoProtegido()); //--Puedo acceder a el mediante la herencia sin necesidad de instancia de clase, directamente.
